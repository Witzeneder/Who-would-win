...
// -------------------END: overlay delegate stuff -------------------
            ...
            while let rest = enumerator.nextObject() as? DataSnapshot {
                if let dic = rest.value as? [String:AnyObject] {
                    ...
                    if self.locationIsInRange(myLocation: location, surveyLocation: location1){
                        // There is a fight in the Location area
                        ...
                        // There are no fights in the Location area
    ...
    /// This methods compares two Locations and calculates the Distance
    /// - Parameters:
    ///   - myLocation: the location of the user
    ///   - surveyLocation: the location of the fight
    /// - Returns: boolean value |TRUE if is in range |False if not
